...
const featuresData: Feature[] = [
  {
    ...
    title: "Easy to Find",
    paragraph:
      "Bolu Jadul Bali is easy to find, with branches conveniently located at Departure Gate 2-3 in Ngurah Rai Airport, Ruko Sunset Plaza No. 150 in Badung, and Sumatra No. 5B in DPS Bali.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "Bolu Jadul Bali only uses the finest, freshest ingredients to produce best quality bolu so customers can enjoy the best quality traditional cake.",
  },
  {
    id: 1,
    icon: (
    ...
    title: "Made With Love and Compassion",
    paragraph:
      "Bolu Jadul Bali is an homage to the true spirit of being a traditional cake that really captures this rich heritage of Bali's gastronomic world. The confectionery masterpiece comes with lovingly created and put-together confections using time-tested recipes and only the freshest ingredients in its ingredients makeup. Each piece contains nostalgia within it, which is good for sharing or personal consumption.",
  },
];
